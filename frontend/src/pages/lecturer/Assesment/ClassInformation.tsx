...
import { BookInformationOutline, EditOutline, IconColorScheme } from "../../../assets/Icons/Fluent";
                        ...
                        <tr>
                            ...
                            <td className="text-[16px]">
                                <Group spacing={"xs"} className="cursor-pointer" align={"center"}>
                                    : Ditentukan Dosen <EditOutline color={IconColorScheme.primaryText} size={20} />
                                </Group></td>
                        </tr>
                        <tr>
                            <td className="text-left font-bold">Posisi Dosen</td>
                            <td className="text-[16px]">: Anggota</td>
                        </tr>
                    </tbody>
                </Table>
            </div>
