...
interface IFEHomepageStudyProgramAdminProps {}

const dummyName : string = "Takdim"
const dummyDate : Date = new Date()

const FEHomepageStudyProgramAdmin: React.FC<IFEHomepageStudyProgramAdminProps> = ({}) => {
...
export default FEHomepageStudyProgramAdmin;
