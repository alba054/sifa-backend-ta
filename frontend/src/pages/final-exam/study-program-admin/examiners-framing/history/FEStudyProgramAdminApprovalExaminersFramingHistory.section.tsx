...
import FEStudyProgramAdminApprovalExaminersFramingHistoryCard, {
  IFEStudyProgramAdminApprovalExaminersFramingHistoryCard,
} from "./FEStudyProgramAdminApprovalExaminersFramingHistoryCard";
...
> = ({}) => {
  ...
  return (
    <>
      ...
      />
      <LFPHeaderComponent
        title="Riwayat Penyusunan Tim Penguji"
        buttons={buttons}
