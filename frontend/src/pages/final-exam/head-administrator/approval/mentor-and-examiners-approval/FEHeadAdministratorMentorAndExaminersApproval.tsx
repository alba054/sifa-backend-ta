...
export interface IFEHeadAdministratorMentorAndExaminersApproval {}

const buttons: ILFPHeaderButton[] = [
  {
    label: "Riwayat Persetujuan",
    type: "href",
    href: FEROUTES.HEAD_ADMINISTRATOR_APPROVAL_MENTOR_AND_EXAMINERS_HISTORY,
...
const FEHeadAdministratorMentorAndExaminersApproval: React.FC<
  IFEHeadAdministratorMentorAndExaminersApproval
> = ({}) => {
...
export default FEHeadAdministratorMentorAndExaminersApproval;
