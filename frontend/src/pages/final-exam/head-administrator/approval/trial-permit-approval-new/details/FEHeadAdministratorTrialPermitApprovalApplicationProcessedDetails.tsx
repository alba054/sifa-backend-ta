...
export interface IFEHeadAdministratorTrialPermitApprovalApplicationProcessedDetails {
  status: string;
}

const FEHeadAdministratorTrialPermitApprovalApplicationProcessedDetails: React.FC<
  IFEHeadAdministratorTrialPermitApprovalApplicationProcessedDetails
> = ({ status }) => {
...
export default FEHeadAdministratorTrialPermitApprovalApplicationProcessedDetails;
