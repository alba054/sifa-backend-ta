...
export interface IFEHeadAdministratorTrialPermitApprovalApplicationUnprocessedDetails {
  setStatus: React.Dispatch<any>;
  // File Di sini?
}

const FEHeadAdministratorTrialPermitApprovalApplicationUnprocessedDetails: React.FC<
  IFEHeadAdministratorTrialPermitApprovalApplicationUnprocessedDetails
> = ({setStatus}) => {
...
export default FEHeadAdministratorTrialPermitApprovalApplicationUnprocessedDetails;
