...
import FEHeadAdministratorTrialPermitApprovalApplicationHistoryMain from "./FEHeadAdministratorTrialPermitApprovalApplicationHistoryMain";
...
const dummyTrialPermitApprovalApplicationHistoryData: Array<IFEHeadAdministratorTrialPermitApprovalApplicationHistoryCard> =
  [
    {
...
> = ({}) => {
  ...
  return (
    ...
    >
      ...
      />
      {isDataExist ? (
        <FEHeadAdministratorTrialPermitApprovalApplicationHistoryMain
