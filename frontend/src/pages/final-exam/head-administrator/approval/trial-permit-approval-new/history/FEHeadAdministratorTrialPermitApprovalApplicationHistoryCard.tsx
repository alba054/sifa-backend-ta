...
export interface IFEHeadAdministratorTrialPermitApprovalApplicationHistoryCard {
  name: string;
  nim: string;
  index?: any;
...
const FEHeadAdministratorTrialPermitApprovalApplicationHistoryCard: React.FC<
...
export default FEHeadAdministratorTrialPermitApprovalApplicationHistoryCard;
