...
export interface IFELecturerSeminarTimeApprovalHistory {}
...
const FELecturerSeminarTimeApprovalHistory: React.FC<
  IFELecturerSeminarTimeApprovalHistory
> = ({}) => {
  const {
...
export default FELecturerSeminarTimeApprovalHistory;
