...
export interface IFEFacultyAdminTrialPermitVerifyCard {
  name: string;
  nim: string;
...
const FEFacultyAdminTrialPermitVerifyCard: React.FC<
  IFEFacultyAdminTrialPermitVerifyCard
> = ({
  index,
  status,
  name,
...
export default FEFacultyAdminTrialPermitVerifyCard;
