...
export interface IFEFacultyAdminTrialPermitVerifyUnprocessedDetails {
  setStatus: React.Dispatch<any>;
  // File Di sini?
}

const FEFacultyAdminTrialPermitVerifyUnprocessedDetails: React.FC<
  IFEFacultyAdminTrialPermitVerifyUnprocessedDetails
> = ({setStatus}) => {
...
export default FEFacultyAdminTrialPermitVerifyUnprocessedDetails;
