...
export interface IFEFacultyAdminTrialPermitVerifyHistoryCard {
  name: string;
  nim: string;
  index?: any;
  status: FEStatus;
...
const FEFacultyAdminTrialPermitVerifyHistoryCard: React.FC<
...
export default FEFacultyAdminTrialPermitVerifyHistoryCard;
