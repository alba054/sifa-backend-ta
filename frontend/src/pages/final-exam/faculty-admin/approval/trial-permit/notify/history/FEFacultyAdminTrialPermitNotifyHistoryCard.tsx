...
export interface IFEFacultyAdminTrialPermitNotifyHistoryCard {
  name: string;
  nim: string;
  index?: any;
  status: FEStatus;
...
const FEFacultyAdminTrialPermitNotifyHistoryCard: React.FC<
...
export default FEFacultyAdminTrialPermitNotifyHistoryCard;
