...
import FEFacultyAdminTrialPermitNotifyHistoryMain from "./FEFacultyAdminTrialPermitNotifyHistoryMain";
export interface IFEFacultyAdminTrialPermitNotifyHistory {}
...
const breadCrumbs: Array<IFEBreadCrumbsItem> = [
  ...
  {
    title: "Notifikasi",
    href: FEROUTES.FACULTY_ADMIN_APPROVAL_TRIAL_PERMIT_NOTIFICATION,
  },
];

const dummyTrialPermitApprovalApplicationHistoryData: Array<IFEFacultyAdminTrialPermitNotifyHistoryCard> =
  [
    {
...
const FEFacultyAdminTrialPermitNotifyHistory: React.FC<
  IFEFacultyAdminTrialPermitNotifyHistory
> = ({}) => {
  const {
  ...
  return (
    ...
    >
      ...
      />
      <LFPHeaderComponent
        title="Riwayat Notifikasi Surat Permohonan"
        buttons={buttons}
        disabledButtonTooltipLabel={"Riwayat kosong"}
      />
      {isDataExist ? (
        <FEFacultyAdminTrialPermitNotifyHistoryMain
...
export default FEFacultyAdminTrialPermitNotifyHistory;
