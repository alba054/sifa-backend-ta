...
interface IFEHomepageSeminarCoordinatorProps {}

const dummyName : string = "Takdim"
const dummyDate : Date = new Date()

const FEHomepageSeminarCoordinator: React.FC<IFEHomepageSeminarCoordinatorProps> = ({}) => {
...
export default FEHomepageSeminarCoordinator;
