...
const FESeminarEvaluation: React.FC<IFESeminarEvaluation> = ({mentorNotes}) => {
      ...
      <Grid className="px-8 mb-0" gutter={32} columns={24}>
        <Grid.Col span={"auto"}>
          <div className="border p-2 border-secondary-500 rounded-xl">
            <FEScoreCircleBar rubric="A" score="80" title="Nilai" />
          </div>
        </Grid.Col>
        <Grid.Col span={17} md={17} sm={24} className="flex flex-col gap-3 overflow-clip">
