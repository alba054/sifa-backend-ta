...
export interface IFEDeanApproval {}

const FEDeanApproval: React.FC<IFEDeanApproval> = ({}) => {
  return (
    <FEMainlayout>
          ...
          <Grid gutter={"xl"} className="mb-0">
            <Grid.Col span={6} xs={12} sm={12} md={6}>
              <FEApprovalCard
                ...
                to={FEROUTES.DEAN_APPROVAL_MENTOR_AND_EXAMINERS}
              />
            </Grid.Col>
          </Grid>
        </Stack>
