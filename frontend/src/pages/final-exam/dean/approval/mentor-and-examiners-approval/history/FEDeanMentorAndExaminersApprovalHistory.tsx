...
import FEDeanMentorAndExaminersApprovalHistoryCard, {
  IFEDeanMentorAndExaminersApprovalHistoryCard,
} from "./FEDeanMentorAndExaminersApprovalHistoryCard";
export interface IFEDeanMentorAndExaminersApprovalHistory {}
...
const dummyProposalHistoryList: Array<IFEDeanMentorAndExaminersApprovalHistoryCard> =
  [
    {
      name: "Devi Selfira",
      nim: "N011181001",
...
const FEDeanMentorAndExaminersApprovalHistory: React.FC<
  IFEDeanMentorAndExaminersApprovalHistory
> = ({}) => {
  const {
  ...
  return (
    <FEMainlayout
      ...
      breadCrumbsCurrentPage="Riwayat Penandatanganan SK"
    >
      <FEAlertModal
        title="Kosongkan Riwayat Penandatanganan SK?"
      ...
      {isDataExist ? (
        <Stack mt={"md"} className="gap-6">
          {proposalHistoryList.map(
            (
              proposal: IFEDeanMentorAndExaminersApprovalHistoryCard,
              e: number
            ) => {
              return (
                <FEDeanMentorAndExaminersApprovalHistoryCard
                  key={e}
                  index={e}
                  onDelete={(e: number) => {
                    onDelete(e);
        ...
        <LFPEmptyDataComponent
          title="Riwayat Penandatanganan SK Kosong"
          caption="Riwayat penandatanganan SK belum ada atau sudah dikosongkan"
          icon={
...
export default FEDeanMentorAndExaminersApprovalHistory;
