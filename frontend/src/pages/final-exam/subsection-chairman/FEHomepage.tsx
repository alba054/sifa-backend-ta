...
interface IFEHomepageSubsectionChairmanProps {}

const dummyName : string = "Takdim"
const dummyDate : Date = new Date()

const FEHomepageSubsectionChairman: React.FC<IFEHomepageSubsectionChairmanProps> = ({}) => {
...
export default FEHomepageSubsectionChairman;
