            ...
            <div className="h-full flex flex-col">
                <Group position="apart">
                    <div className="relative" >
                        <PageTitle>Data Kelas</PageTitle>
                ...
                <div className="flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between border-2 border-t-0 border-[#dfdfdf] items-center py-5 px-5">
                    <Button className="bg-primary-500 hover:bg-primary-700 w-full md:w-fit" leftIcon={<AddFilled size={20} color="#ffffff" />}>Tambah Data</Button>
